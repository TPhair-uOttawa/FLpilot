...
#include "AC_CustomControl_FLC.h"

#include <GCS_MAVLink/GCS.h>

// table of user settable parameters
const AP_Param::GroupInfo AC_CustomControl_FLC::var_info[] = {
    // @Param: PARAM1
    // @DisplayName: FLC param1
    // @Description: Dummy parameter for FLC custom controller backend
    // @User: Advanced
    AP_GROUPINFO("PARAM1", 1, AC_CustomControl_FLC, param1, 0.0f),

    // @Param: PARAM2
    // @DisplayName: FLC param2
    // @Description: Dummy parameter for FLC custom controller backend
    // @User: Advanced
    AP_GROUPINFO("PARAM2", 2, AC_CustomControl_FLC, param2, 0.0f),

    // @Param: PARAM3
    // @DisplayName: FLC param3
    // @Description: Dummy parameter for FLC custom controller backend
    // @User: Advanced
    AP_GROUPINFO("PARAM3", 3, AC_CustomControl_FLC, param3, 0.0f),

    AP_GROUPEND
};

// initialize in the constructor
AC_CustomControl_FLC::AC_CustomControl_FLC(AC_CustomControl& frontend, AP_AHRS_View*& ahrs, AC_AttitudeControl*& att_control, AP_MotorsMulticopter*& motors, float dt) :
...
Vector3f AC_CustomControl_FLC::update(void)
{
    ...
    gcs().send_text(MAV_SEVERITY_INFO,"FLC custom controller working");
...
void AC_CustomControl_FLC::reset(void)
{
}
