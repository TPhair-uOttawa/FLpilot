...
const AP_Param::GroupInfo AC_CustomControl::var_info[] = {
    ...
    // @Values: 0:None, 1:Empty, 2:PID, 3:FLC
    // @RebootRequired: True
    // @User: Advanced
...
void AC_CustomControl::init(void)
{
    switch (CustomControlType(_controller_type))
    {
        ...
        case CustomControlType::CONT_PID:
            ...
            break;
        case CustomControlType::CONT_FLC:
            _backend = NEW_NOTHROW AC_CustomControl_FLC(*this, _ahrs, _att_control, _motors, _dt);
            _backend_var_info[get_type()] = AC_CustomControl_FLC::var_info;
            break;
        default:
            return;
    }
